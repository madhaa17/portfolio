...
export default function CollapseNavigation() {
  ...
  return (
    <div
      ...
      className="fixed bottom-0 left-0 top-0 z-30 hidden w-16 flex-col items-center overflow-hidden rounded-r-2xl px-2 py-4 shadow-[0_3px_10px_rgb(0,0,0,0.2)] transition-all duration-500 hover:w-64 hover:items-stretch hover:p-4 hover:transition-all hover:duration-500 dark:shadow-neutral-800 lg:flex">
